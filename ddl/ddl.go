...
var (
	...
	errUnsupportedDescIndexType = terror.ClassDDL.New(codeUnsupportedDescIndexType,
		"unsupported column type %s for descending index")
...
const (
	...
	codeUnsupportedDescIndexType    = 207
